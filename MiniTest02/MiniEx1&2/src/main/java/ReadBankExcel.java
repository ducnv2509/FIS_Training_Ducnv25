...
public class ReadBankExcel {
    ...
    public static void main(String[] args) throws IOException {
        final String excelFilePath = "C:/demo/transaction_history.xlsx";
            ...
            while (cellIterator.hasNext()) {
                ...
                switch (columnIndex) {
                    case COLUMN_INDEX_ID:
                        book.setTransferType((String) getCellValue(cell));
                        break;
                    case COLUMN_INDEX_TITLE:
                        book.setBankAccount((String) getCellValue(cell));
                        break;
                    case COLUMN_INDEX_QUANTITY:
                        book.setAmount((String) getCellValue(cell));
                        break;
                    case COLUMN_INDEX_PRICE:
                        book.setMessage(getCellValue(cell).toString());
                        break;
                    case COLUMN_INDEX_TOTAL:
                        book.setDateTime(getCellValue(cell).toString());
                        break;
                    default:
                        break;
                }
